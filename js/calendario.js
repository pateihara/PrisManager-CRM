...
//função para adicionar dias em dias com class day e data anterior próxima data no mês anterior e dias do próximo mês e ativo hoje
...
//função obter nome e data do dia do dia ativo e atualizar eventday eventdate
...
//eventos de atualização de função quando um dia está ativo
...
//permitir apenas tempo em eventtime de e para
...
//função para adicionar evento eventsArr
addEventSubmit.addEventListener("click", () => {
  ...
  //seleciona active day e adiciona event class se não adicionado
      ...
      eventsArr.forEach((event) => {
        if (
          ...
          if (event.events.length === 0) {
            ...
            //remova event class desde o dia
            const activeDayEl = document.querySelector(".day.active");
            if (activeDayEl.classList.contains("event")) {
...
//função para salvar events no local storage
function saveEvents() {
